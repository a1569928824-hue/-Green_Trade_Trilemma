...
REPLACEMENTS[22] = (
    ...
    "r = +0.07, and GDI × GEI r = −0.58 (2024 cross-section; pooled across all years, "
    "GDI × GEI r = −0.44). This means the trilemma does not manifest as "
...
REPLACEMENTS[23] = (
    ...
    "GDI and GEI are negatively correlated (r = −0.44 overall pooled, r = −0.73 among "
...
REPLACEMENTS[30] = (
    ...
    "post-policy timing—we obtain a first-stage F-statistic of 311,003, which is "
    ...
    "β_IV = −0.399 (s.e. = 0.096, P < 0.001). The reduced-form (Bartik instrument "
    "directly on the outcome) yields β_RF = −0.804 (s.e. = 0.194, P < 0.001). The OLS "
    "estimate is also negative (β = −0.050, s.e. = 0.015, P = 0.001). This suggests "
