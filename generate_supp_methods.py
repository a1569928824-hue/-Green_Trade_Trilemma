#!/usr/bin/env python3
"""
Generate Supplementary Methods document (Markdown) for Nature submission.
Covers DEK model derivation, Bartik IV details, robustness checks, and ED figure descriptions.
"""
import os

BASE = os.path.dirname(os.path.abspath(__file__))
OUT = os.path.join(BASE, "Supplementary_Methods.md")
...
print(f"Supplementary Methods saved to: {OUT}")
